                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text(languages.lblSubTotal, style: secondaryTextStyle(size: 16)).onTap(() {
                            log(isCurrencyPositionRight);
                          }),
                          8.width,
                          Marquee(
                            child: Row(
                      ...
                      Row(
                        ...
                        children: [
                          Text.rich(
                            TextSpan(
                              children: [
                                TextSpan(text: languages.hintDiscount, style: secondaryTextStyle(size: 16)),
                                TextSpan(
                        ...
                        children: [
                          ...
                          if (bookingDetail.isHourlyService)
                            Row(
                              ...
                              children: [
                                Text('('),
                                PriceWidget(price: bookingDetail.price.validate(), color: appTextSecondaryColor, size: 14, isBoldText: false),
                  ...
                  Row(
                    children: [
                      Text.rich(
                        TextSpan(
                          children: [
                            TextSpan(text: languages.advancePayment, style: secondaryTextStyle(size: 16)),
                            TextSpan(
